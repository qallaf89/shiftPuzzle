...
$(document).ready(function () {
	...
	$(window).resize(function () {
		...
		//only do it if the dialog box is not hidden
		if (!$('#dialog-box2').is(':hidden')) popup2();		
	});	
...
function popup2(message) {
	...
	// calculate the values for center alignment
	var dialogTop =  (maskHeight/1.5) - ($('#dialog-box2').height());  
...
$(document).ready(function () {
	...
	// if user clicked on button, the overlay layer or the dialogbox, close the dialog	
	$('a.btn-ok').click(function () {		
		$('#dialog-overlay, #dialog-box3').hide();		
		return false;
	});
	...
	$(window).resize(function () {
		...
		//only do it if the dialog box is not hidden
		if (!$('#dialog-box3').is(':hidden')) popup3();
	});	
...
function popup3(message) {
	...
	// calculate the values for center alignment
	var dialogTop =  (maskHeight/1.5) - ($('#dialog-box3').height());  
